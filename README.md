DropletPlayerData
=================
Player data storage "Droplet" plugin for the Spout platform to demonstrate the usage of player.dat replacement with H2.
...
## Using the plugin
Simply place the latest [compiled jar][Builds] in Spout's plugins folder and change the `config.yml` located under `plugins/DropletPlayerData`.
...
## The license
DropletPlayerData and all "Droplet" plugins for the Spout platform are licensed under the [MIT License][License].
...
If you are using Git, use this command to clone the project:
    ...
    git clone git://github.com/Droplet/DropletPlayerData.git

Or download the [latest zip archive][Source Download].

## Compiling the source
DropletPlayerData uses Maven to handle its dependencies.
...
[Source]: https://github.com/Droplets/DropletPlayerData
[Source Download]: https://github.com/Droplet/DropletPlayerData/archive/master.zip
[Builds]: http://build.spout.org/job/DropletPlayerData
